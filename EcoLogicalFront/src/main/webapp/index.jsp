        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">¿Quieres Cambiar el Mundo?</h1>
                    <hr class="divider" />
                </div>
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-6 col-sm-5 col-md-8">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/1.png" title="Reducir">
                ...
                <div class="col-lg-6 col-sm-5 col-md-8">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/2.png" title="Reutilizar">
                ...
                <div class="col-lg-6 col-sm-5 col-md-8">
                    <a class="portfolio-box" href="assets/img/portfolio/fullsize/3.png" title="Reciclar">
